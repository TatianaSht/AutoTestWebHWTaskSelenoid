...
public class TutorPageOnStandGBTest {
    ...
    private static final String birthDateInput = "12.22.2002";
    private static final String birthDateDisplay = "22.12.2002";
    ...
    void uploadNewAvatarTest() {
        ...
        profilePage.uploadNewAvatar(new File("src/test/resources/selenideAvatar.jpg"));
